...
import com.deecoders.meribindiya.adapter.MyActiveMembersAdapter;
...
public class MyActiveMembers extends AppCompatActivity {
    ...
    @BindView(R.id.myActiveMembersList)
    ...
    private MyActiveMembersAdapter myActiveMembersAdapter;
    ...
    private void getActiveMembers() {
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, Constants.getActiveMembers + "/" + MyPref.getId(this), null,
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                myActiveMembersAdapter = new MyActiveMembersAdapter(MyActiveMembers.this, models);
                                mRecyclerView.setAdapter(myActiveMembersAdapter);
                                if(models.size() == 0){
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (progressBar == null)
                    return;
                progressBar.setVisibility(View.GONE);
                Toast.makeText(MyActiveMembers.this, "Network Problem!", Toast.LENGTH_SHORT).show();
            }
        });
        Volley.newRequestQueue(MyActiveMembers.this).add(req);
    }
}
