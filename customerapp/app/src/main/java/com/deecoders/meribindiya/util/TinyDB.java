...
public class TinyDB {
    ...
    public ArrayList<ProductModel> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<ProductModel> objects =  new ArrayList<>();
...
//    }
    ...
    public void putListObject(String key, ArrayList<ProductModel> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
